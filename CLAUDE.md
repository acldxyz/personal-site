...
Content Library → `links.html`, Contact → `mailto:adam@acld.xyz`.
...
**Only the home page has moved to the new language.** About, Bookshelf and
Content Library are still the old one, so the menu drops visitors into a
different-looking site — a known transitional state, to be made uniform in a
later pass. The naming diverges too: the new menu says Bookshelf and Content
Library where those pages still say Reading List and Links.
